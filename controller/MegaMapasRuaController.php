...
class MegaMapasRuaController
{
    ...
    {   
        ...
        $this->service = new MegaMapasRuaService();
        $this->view = new MegaMapasPrincipalView();
    }

    public function obterRua($rota)  
    {
        $resultado = null;
        ...
        try { 
            ...
            //service
            if ($this->validator->validarClasseMetodo($this->service, 'buscarRua')) 
            {

                $service = $this->service->buscarRua($rota);
                ...
                $this->mensagem[] = MegaMapasPrincipalException::inexistente(__METHOD__, "buscarRua.inexistente");
            }
