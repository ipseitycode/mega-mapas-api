<?php
class MegaMapasRegiaoController
{
    private $validator; 
    private $service;  
    private $view;  
    ...
    {   
        ...
        $this->service = new MegaMapasRegiaoService();
        $this->view = new MegaMapasPrincipalView();
    }

    public function obterRegiao($rota)  
    {
        $resultado = null;
        ...
        try { 
            ...
            //service
            if ($this->validator->validarClasseMetodo($this->service, 'buscarRegiao')) 
            {

                $service = $this->service->buscarRegiao($rota);
                ...
                $this->mensagem[] = MegaMapasPrincipalException::inexistente(__METHOD__, "buscarRegiao.inexistente");
            }
