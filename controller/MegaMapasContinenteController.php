<?php
class MegaMapasContinenteController
{
    private $validator; 
    private $service;  
    private $view;  
    ...
    {   
        ...
        $this->service = new MegaMapasContinenteService();
        $this->view = new MegaMapasPrincipalView();
    }

    public function obterContinente($rota)  
    {
        $resultado = null;
        ...
        try {
            ...
            //service
            if ($this->validator->validarClasseMetodo($this->service, 'buscarContinente')) 
            {

                $service = $this->service->buscarContinente($rota);
                ...
                $this->mensagem[] = MegaMapasPrincipalException::inexistente(__METHOD__, "buscarContinente.inexistente");
            }
