<?php
class MegaMapasEstadoController
{
    private $validator; 
    private $service;  
    private $view;  
    ...
    {   
        ...
        $this->service = new MegaMapasEstadoService();
        $this->view = new MegaMapasPrincipalView();
    }

    public function obterEstado($rota)  
    {
        $resultado = null;
        ...
        try { 
            ...
            //service
            if ($this->validator->validarClasseMetodo($this->service, 'buscarEstado')) 
            {

                $service = $this->service->buscarEstado($rota);
                ...
                $this->mensagem[] = MegaMapasPrincipalException::inexistente(__METHOD__, "buscarEstado.inexistente");
            }
